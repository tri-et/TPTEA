    ...
    <q-modal-layout>
      ...
      <div id="labels" class=" transbox">
        <q-btn flat icon="close" @click="opened = false">
          <div style="margin-left: 10px; text-transform: initial;">test</div>
        </q-btn>
      </div>
      <img src="assets/component.jpg" alt="ww" style="width: 683px; height:300px">
      <q-btn flat icon="close" class="absolute-top-left" @click="opened = false" style="color: white;" />
